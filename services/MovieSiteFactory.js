nicksFlicks.factory('MovieSiteFactory', function MovieSiteFactory() {
  ...
  factory.reviews = [
    ...
    {id: 2,
     title: "Just caught the weirdest movie",
     ...
     {id: 3,
      title: "Killer Effects in Speed 2",
      description: "Highly recommend this movie for any dude who just wants to hang out, crack open a cold one, and watch some action packed action on a cruise ship."}
];
